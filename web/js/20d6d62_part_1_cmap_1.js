$("document").ready(function() {
	$(".cp").keyup(function() {
		if ($(this).val().length === 5 ) {
			$.ajax({
				type: 'get',
				url: "http://localhost/Symfony/web/app_dev.php/annonce/villes/" + $(this).val(),
				beforeSend: function() {
					 if ($(".loading").length == 0) {
...
var $overlay=$('.overlay'),
    $trigger=$('.circle');
	$place=$('.envelope_contact');
	$velop_top=$('.envelope-top');
	$velop=$('.envelope');
	$circ=$('.circle');
...
$('.close-button').click(function(){
  ...
  $velop_top.removeClass('open');
  $velop.removeClass('open');
  $circ.removeClass('open');
})
...
theToggle.onclick = function() {
   ...
   return false;
		...
		var mapfill = "#3D9FD0";		// Couleur de remplissage des régions
		var maphover_fill = "#DB425C";	// Couleur de survol au passage de la souris
		...
		var path="http://localhost/Symfony/web/app_dev.php/annonce/place/";
...
url: "" + path + "Alsace-Champagne-Ardenne-Lorraine"
},
Z2: {
title: "Aquitaine-Limousin-Poitou-Charentes",
url: "" + path + "Aquitaine-Limousin-Poitou-Charentes"
},
Z3: {
title: "Auvergne-Rhône-Alpes",
url: "" + path + "Auvergne-Rhônes-Alpes"
},
Z4: {
title: "Bourgogne-Franche-Comté",
url: "" + path + "Bourgogne-Franche-Comté"
},
Z5: {
title: "Bretagne",
url: "" + path + "Bretagne"
...
url: "" + path + "Languedoc-Roussillon-Midi-Pyrénées"
},
Z9: {
title: "Ile-de-France",
url: "" + path + "Ile-de-France"
},
Z10: {
title: "Nord-Pas-de-Calais-Picardie",
url: "" + path + "Nord-Pas-de-Calais-Picardie"
},
Z11: {
title: "Normandie",
url: "" + path + "Normandie"
...
url: "" + path + "Pays-de-la-Loire"
},
Z13: {
title: "Provence-Alpes-Côte-d-Azur",
url: "" + path + "Provence-Alpes-Côte-d-Azur"
}
}
