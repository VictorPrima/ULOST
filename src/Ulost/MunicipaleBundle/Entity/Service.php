...
/**
 * @ORM\Entity(repositoryClass="Ulost\MunicipaleBundle\Repository\ServiceRepository")
...
class Service
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Ulost\VilleBundle\Entity\Ville", inversedBy="services")
